...
getting_loader(1, save=True, num_workers=2, variant = 1, train_p=0.7, saved=False, drop_qb_orientation = True, get_dataset=False, all_frames=False, distr_analysis=False, i=4, play_id=None, game_id=None)
