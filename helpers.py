...
getting_loader(1, save=True, num_workers=2, variant = 1, train_p=0.9, saved=False, drop_qb_orientation = False, get_dataset=False, all_frames=False, distr_analysis=False, i=4, play_id=None, game_id=None, split=False)
getting_loader(1, save=True, num_workers=2, variant = 2, train_p=0.9, saved=False, drop_qb_orientation = False, get_dataset=False, all_frames=False, distr_analysis=False, i=4, play_id=None, game_id=None, split=False)
getting_loader(1, save=True, num_workers=2, variant = 3, train_p=0.9, saved=False, drop_qb_orientation = False, get_dataset=False, all_frames=False, distr_analysis=False, i=4, play_id=None, game_id=None, split=False)
getting_loader(1, save=True, num_workers=2, variant = 5, train_p=0.9, saved=False, drop_qb_orientation = False, get_dataset=False, all_frames=False, distr_analysis=False, i=4, play_id=None, game_id=None, split=False)
getting_loader(1, save=True, num_workers=2, variant = 6, train_p=0.9, saved=False, drop_qb_orientation = False, get_dataset=False, all_frames=False, distr_analysis=False, i=4, play_id=None, game_id=None, split=False)
