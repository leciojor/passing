...
# train_loader, val_loader, dataset = getting_loader(16, save=True, num_workers=0, variant = 1, train_p=0.8, saved=True, distr_analysis=False, get_dataset=True, drop_qb_orientation=False, beta=False, just_shoulder_orientation=True)
