...
train_loader, val_loader, dataset = getting_loader(16, save=False, num_workers=0, variant = 1, train_p=0.9, saved=True, distr_analysis=False, get_dataset=True, drop_qb_orientation=True, beta=True)
...
train_loader, val_loader, dataset = getting_loader(16, save=False, num_workers=0, variant = 1, train_p=0.9, saved=True, distr_analysis=False, get_dataset=True, drop_qb_orientation=False, beta=True)
net = DeepQBVariant1(input_dim=dataset.col_size - 5, output_dim=5)
optimizer = torch.optim.Adam(lr=lr, params=net.parameters())
...
train_loader, val_loader, dataset = getting_loader(16, save=False, num_workers=0, variant = 1, train_p=0.9, saved=False, distr_analysis=False, get_dataset=True, drop_qb_orientation=False, beta=False, just_shoulder_orientation=True)
net = DeepQBVariant1(input_dim=dataset.col_size - 5, output_dim=5)
optimizer = torch.optim.Adam(lr=lr, params=net.parameters())
version = f"variant1_lr{lr}_n{n}_with shoulder orientation"
loss_training, acc_training, loss_val, acc_val = train(net, optimizer, nn.CrossEntropyLoss(), train_loader, val_loader, n, 1000, 1000, None, version, t=1, pretrained=False)
...
train_loader, val_loader, dataset = getting_loader(16, save=False, num_workers=0, variant = 2, train_p=0.9, saved=False, distr_analysis=False, get_dataset=True, beta=True, intended_receiver_input=True)
...
train_loader, val_loader, dataset = getting_loader(16, save=False, num_workers=0, variant = 5, train_p=0.9, saved=False, distr_analysis=False, get_dataset=True, beta=True, intended_receiver_input=True)
net = DeepQBVariant1(input_dim=dataset.col_size - 1, output_dim=1)
optimizer = torch.optim.Adam(lr=lr, params=net.parameters())
...
train_loader, val_loader, dataset = getting_loader(16, save=False, num_workers=0, variant = 6, train_p=0.9, saved=True, distr_analysis=False, get_dataset=True, beta=True)
...
train_loader, val_loader, dataset = getting_loader(16, save=False, num_workers=0, variant = 5, train_p=0.9, saved=True, distr_analysis=False, get_dataset=True, beta=True)
net = DeepQBVariant1(input_dim=dataset.col_size - 1, output_dim=1)
optimizer = torch.optim.Adam(lr=lr, params=net.parameters())
version = f"variant5_lr{lr}_n{n}"
loss_training, acc_training, loss_val, acc_val = train(net, optimizer, nn.BCEWithLogitsLoss(), train_loader, val_loader, n, 1000, 1000, None, version, t=5, pretrained=False)
